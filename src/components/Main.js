  ...
  render(){
    ...
    return (
      <figure className={imgFigureClassName} style={styleObj} ref="figure"
        ...
        <img className='img-back' src={this.props.data.imageURL} alt={this.props.data.title} />
        <figcaption>
  ...
  render() {
    ...
    imageDatas.forEach(function(value,index){
      ...
      imgFigures.push(<ImgFigure key={index}  ref={'imgFigure'+index} data={value}
        arrange={this.state.imgsArrangeArr[index]} inverse={this.inverse(index).bind(this)}
